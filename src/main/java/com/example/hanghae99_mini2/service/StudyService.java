...
public class StudyService {
    ...
    public Study createStudy(StudyRegisterDto requestDto, Long userId) {
...
//        Long registeredUserId = user.getId();
        // (테스트용)
//        Long registeredUserId = userRepository.findByUsername(username).get().getId();

//        Long registeredUserId = 1L;

        Study study = new Study(requestDto, userId);
